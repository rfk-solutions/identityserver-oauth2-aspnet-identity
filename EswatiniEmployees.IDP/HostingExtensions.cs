using EmailService;
using EswatiniEmployees.IDP.CustomTokenProviders;
...
internal static class HostingExtensions
{
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        .AddGoogle(options =>
        {
            options.ClientId = "172208881356-serqqj1hhp6tl03iqdkbopjromid7svm.apps.googleusercontent.com";
            options.ClientSecret = "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";
        });
